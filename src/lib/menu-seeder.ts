...
export async function ensureHmsMenus() {
    ...
    try {
        const hmsItems = [
            ...
            { key: 'hms-dashboard', label: 'HMS Dashboard', url: '/hms/dashboard', icon: 'LayoutDashboard', sort: 30, permission: 'hms:admin' },
            { key: 'hms-analytics', label: 'Analytics & Trends', url: '/hms/analytics', icon: 'BarChart3', sort: 31, permission: 'hms:admin' },
